function DraftCard({ title, questions, createdAt, onStart, onEdit }) {
    return (
        <div className="bg-surface rounded-card p-6 transition-all duration-200 cursor-pointer shadow-[0_4px_6px_rgba(0,0,0,0.2)] hover:-translate-y-1 hover:shadow-[0_8px_16px_rgba(0,0,0,0.3)]">
            ...
            <div className="flex gap-3">
                <button onClick={onEdit} className="flex-1 py-2.5 px-5 border border-primary-container rounded-btn font-medium text-sm text-primary-container bg-transparent cursor-pointer transition-all duration-200 hover:bg-primary-container/10 hover:-translate-y-0.5">
                    Edit
                </button>
