...
function PasswordRecovery() {
    ...
    const handleSubmit = (e) => {
        ...
        //TO DO: Implement actual password recovery (antonio)
        setSubmitted(true)
    }
                ...
                {!submitted ? (
                    <>
                        ...
                        <p className="text-primary-container text-center text-sm mb-6">
                            Insert your email and we'll send you a link to reset your password
                        </p>
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-primary-container text-sm mb-6">
                            Control your email for the link to reset your password
                        </p>
                    </div>
                )}
